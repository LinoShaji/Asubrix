...
List<Restraunts> restrauntsFromJson(String str) => List<Restraunts>.from(json.decode(str).map((x) => Restraunts.fromJson(x)));

String restrauntsToJson(List<Restraunts> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
